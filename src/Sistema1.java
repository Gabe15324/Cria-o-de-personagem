...
public class Sistema1 {
    private ArrayList<Personagem1> listaPersonagens = new ArrayList<>();
    ...
    public void cadastrarMago(Scanner scanner) {
        ...
        Mago1 novoMago = new Mago1(nome, ataque, defesa);
    ...
    public void cadastrarCurador(Scanner scanner) {
        ...
        Curador1 novoCurador = new Curador1(nome, ataque, defesa);
    ...
    public void cadastrarAtirador(Scanner scanner) {
        ...
        Atirador1 novoAtirador = new Atirador1(nome, ataque, defesa);
    ...
    public void buscarPersonagem(Scanner scanner) {
        ...
        for (Personagem1 personagem : listaPersonagens) {
